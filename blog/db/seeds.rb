...
admin = User.create(username: "admin", password_digest: "p30p!epoWer51")
...
DCFuture.com is the virtual town square where DC residents can learn about our unique city, think big about its future, plug into the hot and emerging issue and political campaigns of the moment, and even start their own campaigns.", user: admin)
